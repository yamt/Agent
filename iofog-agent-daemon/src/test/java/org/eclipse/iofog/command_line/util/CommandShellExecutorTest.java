...
public class CommandShellExecutorTest {
    ...
    public void executeCommandWithInvalidCommand() {
        ...
        commandShellResultSet = new CommandShellResultSet<>(value, errors);
        System.out.println(commandShellExecutor.executeCommand(command));
    ...
    public void executeScript() {
        ...
        commandShellResultSet = new CommandShellResultSet<>(value, errors);
        System.out.println(commandShellExecutor.executeScript(command, "agent"));
     ...
     */
    @Test
    public void executeDynamicInvalidCommand() {
        command = "invalid";
        value = new ArrayList<>();
        errors = new ArrayList<>();
